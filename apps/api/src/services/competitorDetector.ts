...
export interface CompetitorContext {
    /** The resolved competitor name (as it appears in the dataset) */
    competitorName: string;
    /** The canonical dimension to filter on */
    sourceColumn: "thirdparty";
    /** How the competitor was detected */
    matchedIn: "phrase_extraction" | "entity_resolution";
}
 ...
 */
export function detectCompetitorContext(
    question: string,
    metadata: DatasetMetadata,
    existingFilters?: Array<{ dimension: string; value: string | number }>
 ...
 */
function fuzzyMatchThirdParty(candidate: string, thirdParties: string[]): string | null {
