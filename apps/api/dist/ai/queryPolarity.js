...
export function detectQueryPolarity(question) {
...
export function polarityToSortDirection(polarity) {
...
export function detectSortDirection(question) {
    return polarityToSortDirection(detectQueryPolarity(question));
}
export function isNegativeIntent(question) {
    return detectQueryPolarity(question) === "NEGATIVE";
}
export function isPositiveIntent(question) {
