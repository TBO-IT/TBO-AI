...
export const DIMENSION_SYNONYMS = [
    {
...
export const DATASET_METRIC_AVAILABILITY = {
...
// ─── Helpers ──────────────────────────────────────────────────────────────────
export function normalizeMetric(text) {
...
export function normalizeDimension(text) {
    const normalized = text.toLowerCase().trim();
