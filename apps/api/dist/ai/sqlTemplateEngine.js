 ...
 */
function getPhysicalColumnName(canonicalKey, semanticLayer) {
 ...
 */
function detectSortDirection(question) {
 ...
 */
function buildEntityFilterConditions(entityFilters, semanticLayer) {
 ...
 */
export function generateTemplatedSql(analysis, semanticLayer) {
