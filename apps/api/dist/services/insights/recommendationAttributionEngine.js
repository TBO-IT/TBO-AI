...
export function generateAttributedRecommendations(primaryTarget, drilldowns, competitorContext, metricName = "performance metric") {
    ...
    for (const drilldown of drilldowns) {
        ...
        recommendations.push({
            targetType: drilldown.entityType,
