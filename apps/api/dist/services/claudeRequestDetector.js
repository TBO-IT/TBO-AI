 ...
 */
export function detectNarrativeRequest(question) {
 ...
 */
export function detectRecommendationRequest(question) {
    const q = question.toLowerCase();
 ...
 */
export function isExecutiveQuestion(question) {
    const q = question.toLowerCase();
 ...
 */
export function isExecutivePriorityQuestion(question) {
    const q = question.toLowerCase();
    const patterns = [
        /focus\s+on/i,
        /highest\s+roi/i,
 ...
 */
export function classifyResponseSource(question) {
    if (detectRecommendationRequest(question))
        return "CLAUDE_RECOMMENDATION";
    if (detectNarrativeRequest(question))
